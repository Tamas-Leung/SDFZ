...
public class PowerUpMethods
{
    public static PowerUp[] powerUps = {
        ...
        new PowerUp(UpgradeOption.IncreaseMoveSpeed, 5f, UpgradeTier.Epic),
        new PowerUp(UpgradeOption.IncreaseMoveSpeed, 2f, UpgradeTier.Rare),
        new PowerUp(UpgradeOption.IncreaseMoveSpeed, 1f, UpgradeTier.Common),
        ...
        new PowerUp(UpgradeOption.IncreaseDashRange, 10f, UpgradeTier.Epic),
        new PowerUp(UpgradeOption.IncreaseDashRange, 4f, UpgradeTier.Rare),
        new PowerUp(UpgradeOption.IncreaseDashRange, 2f, UpgradeTier.Common),
        new PowerUp(UpgradeOption.DecreaseDashCooldown, 0.5f, UpgradeTier.Epic),
